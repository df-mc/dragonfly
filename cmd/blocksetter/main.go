...
func (b *setterBuilder) checkCollision(structName, method string) {
	if _, ok := b.methods[structName+"."+method]; ok {
		log.Fatalln(structName + "." + method + " is generated by cmd/blocksetter and must not be written by hand.")
	}
}
