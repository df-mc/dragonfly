...
type Handler interface {
	...
	HandleAttackEntity(ctx *Context, e world.Entity, force, height, friction *float64, critical *bool)
...
func (NopHandler) HandleAttackEntity(*Context, world.Entity, *float64, *float64, *float64, *bool) {}
