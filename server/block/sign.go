...
func (s Sign) DecodeNBT(data map[string]any) any {
	s.Text = nbtconv.Read[string](data, "Text")
	s.BaseColour = nbtconv.RGBAFromInt32(nbtconv.Read[int32](data, "SignTextColor"))
	s.Glowing = nbtconv.Read[byte](data, "IgnoreLighting") == 1 && nbtconv.Read[byte](data, "TextIgnoreLegacyBugResolved") == 1
