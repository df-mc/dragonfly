...
func (s Sign) DecodeNBT(data map[string]any) any {
	...
	if ok {
		s.Front.BaseColour = colourconv.RGBAFromInt32(nbtconv.Int32(front, "SignTextColor"))
	...
	if ok {
		s.Back.BaseColour = colourconv.RGBAFromInt32(nbtconv.Int32(back, "SignTextColor"))
