...
func init() {
	...
	world.RegisterBlock(Mushroom{Type: BrownMushroom()})
	world.RegisterBlock(Mushroom{Type: RedMushroom()})
...
func init() {
	...
	world.RegisterItem(Mushroom{Type: BrownMushroom()})
	world.RegisterItem(Mushroom{Type: RedMushroom()})
