...
func init() {
	...
	world.RegisterItem(SandstoneSlab{Cut: true})
	world.RegisterItem(SandstoneSlab{Double: true, Cut: true})
	world.RegisterItem(SandstoneSlab{Double: true, Red: true, Cut: true})
	world.RegisterItem(SandstoneSlab{Double: true, Red: true, Smooth: true})
	world.RegisterItem(SandstoneSlab{Double: true, Red: true})
	world.RegisterItem(SandstoneSlab{Double: true, Smooth: true})
	world.RegisterItem(SandstoneSlab{Double: true})
	world.RegisterItem(SandstoneSlab{Red: true, Cut: true})
	world.RegisterItem(SandstoneSlab{Red: true, Smooth: true})
	world.RegisterItem(SandstoneSlab{Red: true})
	world.RegisterItem(SandstoneSlab{Smooth: true})
