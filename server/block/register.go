...
func init() {
	...
	world.RegisterItem(item.Bucket{Content: item.LiquidContent(Lava{})})
	world.RegisterItem(item.Bucket{Content: item.LiquidContent(Water{})})
	world.RegisterItem(item.Bucket{Content: item.MilkContent()})
