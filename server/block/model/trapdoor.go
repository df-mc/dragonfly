...
func (t Trapdoor) BBox(cube.Pos, *world.World) []cube.BBox {
	if t.Open {
		return []cube.BBox{cube.Box(mgl64.Vec3{}, mgl64.Vec3{1, 1, 1}).ExtendTowards(t.Facing.Face(), -0.8125)}
	} else if t.Top {
		return []cube.BBox{cube.Box(mgl64.Vec3{0, 0.8125}, mgl64.Vec3{1, 1, 1})}
	}
	return []cube.BBox{cube.Box(mgl64.Vec3{}, mgl64.Vec3{1, 0.1875, 1})}
}
