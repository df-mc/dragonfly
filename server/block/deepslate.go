...
func (d Deepslate) BreakInfo() BreakInfo {
	if d.Type == NormalDeepslate() {
		return newBreakInfo(3, pickaxeHarvestable, pickaxeEffective, silkTouchOneOf(Deepslate{Type: CobbledDeepslate()}, d), nil).withBlastResistance(18)
	}
	return newBreakInfo(3.5, pickaxeHarvestable, pickaxeEffective, oneOf(d), nil).withBlastResistance(18)
}
