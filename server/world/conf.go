...
type Config struct {
	...
	// generate chunks. It defaults to 1, which keeps chunk generation fully
	// sequential. Higher values make loading and generating chunks faster,
	// but require the Generator to be safe for concurrent use.
