...
type Handler interface {
	...
	HandleExplosion(ctx *Context, entities *[]Entity, blocks *[]cube.Pos, itemDropChance *float64, fire *bool)
...
func (NopHandler) HandleExplosion(*Context, *[]Entity, *[]cube.Pos, *float64, *bool) {}
