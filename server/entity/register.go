...
var conf = world.EntityRegistryConfig{
	...
	Arrow: func(opts world.EntitySpawnOpts, damage float64, owner world.Entity, critical, disallowPickup, obtainArrowOnPickup, fixedDamage bool, punchLevel int, tip any) *world.EntityHandle {
		conf := arrowConf
