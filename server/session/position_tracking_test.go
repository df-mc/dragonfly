...
func TestHoldsTrackingCompass(t *testing.T) {
	...
	newSession := func() *Session {
		s := &Session{inv: inventory.New(36, nil), offHand: inventory.New(1, nil), ui: inventory.New(54, nil), enderChest: inventory.New(27, nil)}
	...
	for _, c := range []struct {
		...
		{"ender chest", func(s *Session) { _ = s.enderChest.SetItem(0, compass) }},
