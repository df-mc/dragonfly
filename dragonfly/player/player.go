...
import (
	...
	"git.jetbrains.space/dragonfly/dragonfly/dragonfly/player/bossbar"
	"git.jetbrains.space/dragonfly/dragonfly/dragonfly/player/chat"
	"git.jetbrains.space/dragonfly/dragonfly/dragonfly/player/scoreboard"
	"git.jetbrains.space/dragonfly/dragonfly/dragonfly/player/skin"
	"git.jetbrains.space/dragonfly/dragonfly/dragonfly/player/title"
	"git.jetbrains.space/dragonfly/dragonfly/dragonfly/session"
