...
type Tier struct {
	...
	HarvestLevel int
	// BaseMiningEfficiency is the basic efficiency of the tier, when it comes to mining blocks. This is
...
var TierWood = Tier{HarvestLevel: 1, Durability: 59, BaseMiningEfficiency: 2}

// TierGold is the tier of gold tools.
var TierGold = Tier{HarvestLevel: 1, Durability: 32, BaseMiningEfficiency: 12}

// TierStone is the tier of stone tools.
var TierStone = Tier{HarvestLevel: 2, Durability: 131, BaseMiningEfficiency: 4}

// TierIron is the tier of iron tools.
var TierIron = Tier{HarvestLevel: 3, Durability: 250, BaseMiningEfficiency: 6}

// TierDiamond is the tier of diamond tools.
var TierDiamond = Tier{HarvestLevel: 4, Durability: 1561, BaseMiningEfficiency: 8}
...
var TierNetherite = Tier{HarvestLevel: 4, Durability: 2031, BaseMiningEfficiency: 9}
