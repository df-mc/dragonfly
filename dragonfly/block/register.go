...
func init() {
	...
	world.RegisterItem("minecraft:fence_gate", FenceGate{Wood: wood.Oak()})
	world.RegisterItem("minecraft:spruce_fence_gate", FenceGate{Wood: wood.Spruce()})
	world.RegisterItem("minecraft:birch_fence_gate", FenceGate{Wood: wood.Birch()})
	world.RegisterItem("minecraft:jungle_fence_gate", FenceGate{Wood: wood.Jungle()})
	world.RegisterItem("minecraft:acacia_fence_gate", FenceGate{Wood: wood.Acacia()})
	world.RegisterItem("minecraft:dark_oak_fence_gate", FenceGate{Wood: wood.DarkOak()})
