...
func init() {
	...
	world.RegisterItem("minecraft:fence", WoodenFence{Wood: wood.Oak()})
	world.RegisterItem("minecraft:fence", WoodenFence{Wood: wood.Spruce()})
	world.RegisterItem("minecraft:fence", WoodenFence{Wood: wood.Birch()})
	world.RegisterItem("minecraft:fence", WoodenFence{Wood: wood.Jungle()})
	world.RegisterItem("minecraft:fence", WoodenFence{Wood: wood.Acacia()})
	world.RegisterItem("minecraft:fence", WoodenFence{Wood: wood.DarkOak()})
	world.RegisterItem("minecraft:crimson_fence", WoodenFence{Wood: wood.Crimson()})
	world.RegisterItem("minecraft:warped_fence", WoodenFence{Wood: wood.Warped()})
