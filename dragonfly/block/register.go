...
func init() {
	_ = world.RegisterBlock(Air{})
	_ = world.RegisterBlock(Stone{})
	_ = world.RegisterBlock(Stone{Smooth: true})
	_ = world.RegisterBlock(Granite{})
	_ = world.RegisterBlock(Granite{Polished: true})
	_ = world.RegisterBlock(Diorite{})
	_ = world.RegisterBlock(Diorite{Polished: true})
	_ = world.RegisterBlock(Andesite{})
	_ = world.RegisterBlock(Andesite{Polished: true})
	_ = world.RegisterBlock(Grass{})
	_ = world.RegisterBlock(GrassPath{})
	_ = world.RegisterBlock(Dirt{})
	_ = world.RegisterBlock(Dirt{Coarse: true})
	_ = world.RegisterBlock(Cobblestone{})
	_ = world.RegisterBlock(Cobblestone{Mossy: true})
	_ = world.RegisterBlock(Bedrock{})
	_ = world.RegisterBlock(Bedrock{InfiniteBurning: true})
	_ = world.RegisterBlock(Obsidian{})
	_ = world.RegisterBlock(DiamondBlock{})
	_ = world.RegisterBlock(Glass{})
	_ = world.RegisterBlock(Glowstone{})
	_ = world.RegisterBlock(EmeraldBlock{})
	_ = world.RegisterBlock(EndBricks{})
	_ = world.RegisterBlock(GoldBlock{})
	_ = world.RegisterBlock(NetheriteBlock{})
	_ = world.RegisterBlock(IronBlock{})
	_ = world.RegisterBlock(CoalBlock{})
	_ = world.RegisterBlock(Beacon{})
	_ = world.RegisterBlock(Sponge{})
	_ = world.RegisterBlock(Sponge{Wet: true})
	_ = world.RegisterBlock(LapisBlock{})
	_ = world.RegisterBlock(Terracotta{})
	_ = world.RegisterBlock(GlassPane{})
	_ = world.RegisterBlock(IronBars{})
	_ = world.RegisterBlock(NetherBrickFence{})
	_ = world.RegisterBlock(EndStone{})
	_ = world.RegisterBlock(Netherrack{})
	_ = world.RegisterBlock(QuartzBricks{})
	_ = world.RegisterBlock(Clay{})
	_ = world.RegisterBlock(AncientDebris{})
	_ = world.RegisterBlock(EmeraldOre{})
	_ = world.RegisterBlock(DiamondOre{})
	_ = world.RegisterBlock(LapisOre{})
	_ = world.RegisterBlock(NetherGoldOre{})
	_ = world.RegisterBlock(GoldOre{})
	_ = world.RegisterBlock(IronOre{})
	_ = world.RegisterBlock(CoalOre{})
	_ = world.RegisterBlock(NetherQuartzOre{})
	_ = world.RegisterBlock(Melon{})
	_ = world.RegisterBlock(Sand{})
	_ = world.RegisterBlock(Sand{Red: true})
	_ = world.RegisterBlock(Gravel{})
	_ = world.RegisterBlock(Bricks{})
	_ = world.RegisterBlock(SoulSand{})
	_ = world.RegisterBlock(Barrier{})
	_ = world.RegisterBlock(CryingObsidian{})
	_ = world.RegisterBlock(SeaLantern{})
	_ = world.RegisterBlock(SoulSoil{})
	_ = world.RegisterBlock(BlueIce{})
	_ = world.RegisterBlock(GildedBlackstone{})
	_ = world.RegisterBlock(Shroomlight{})
	_ = world.RegisterBlock(InvisibleBedrock{})
	_ = world.RegisterBlock(DragonEgg{})
