...
func init() {
	...
	world.RegisterBlock(ChiseledSandstone{Red: true}, ChiseledSandstone{})
	world.RegisterBlock(CutSandstone{Red: true}, CutSandstone{})
...
func init() {
	...
	world.RegisterItem("minecraft:sandstone", ChiseledSandstone{Red: false})
	world.RegisterItem("minecraft:sandstone", CutSandstone{Red: false})
	...
	world.RegisterItem("minecraft:red_sandstone", ChiseledSandstone{Red: true})
	world.RegisterItem("minecraft:red_sandstone", CutSandstone{Red: true})
